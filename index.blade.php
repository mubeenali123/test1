...
<title>Topico - Online Shopping In Pakistan </title>
...
<span>Welcome to Worldwide Ecommerce Store</span>
</div>
</div>
...
<main>
<!-- slider area satrt -->
<section class="slider__area pt-70 pb-100">
<div class="container">
<div class="row">
...
<div class="col-xl-10 custom-col-10 col-lg-10">
<div class="row">
<div class="col-xl-12 custom-col-12 col-lg-12">
<div class="slider__inner slider-active">
<div class="single-slider w-img">
    <img src="images/1234.jpg" alt="slider">
</div>
<div class="single-slider w-img">
    <img src="images/12345.jpg" alt="slider">
</div>
<div class="single-slider w-img">
    <img src="images/123456.jpg" alt="slider">
</div>
</div>
</div>
...
<a href="product-details.html"><img src="images/chair-banner_486x220.jpg" alt=""></a>
</div>
</div>
<div class="col-xl-4 col-lg-4 col-md-6">
<div class="banner__item mb-30 w-img">
<a href="product-details.html"><img src="images/headset-bannerr_486x220.jpg" alt=""></a>
</div>
</div>
<div class="col-xl-4 col-lg-4 col-md-6">
<div class="banner__item mb-30 w-img">
<a href="product-details.html"><img src="images/graphics-card-banner_486x220.jpg" alt=""></a>
</div>
</div>
</div>
</div>
...
<div class="product__item white-bg"><span class="cat-label green">new!</span>
    <div class="product__thumb p-relative">
        <a href="product-details.html" class="w-img">
            <img src="images/bag-1.jpg" alt="product">
            <img class="second-img" src="images/bag-1-2.jpg" alt="product">
        </a>
    ...
    <div class="product__content text-center">
        <h6 class="product-name">
                   ...
                   <tr>
                    ...
                    <td><a class="product-item-link" href="product-details.php?val="> Durable high quality bag for men  traveling sports bag pack</a></td>
        </h6>
        <div class="rating">
            <ul>
...
<div class="product__item white-bg"><span class="cat-label green">new!</span>
    <div class="product__thumb p-relative">
        <a href="product-details.html" class="w-img">
            <img src="images/usb-1.jpg" alt="product">
            <img class="second-img" src="images/usb-1-2.jpg" alt="product">
        </a>
        <div class="product__action p-absolute">
            <ul>
                <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
    ...
    <div class="product__content text-center">
        <h6 class="product-name">
        <td>
                 <a class="product-item-link" href="product-details.php?val="> Motorno type-c usb dual pendrive OTG USB Flash Drive</a>
        </td>
...
<div class="product__item white-bg"><span class="cat-label green">new!</span>
    <div class="product__thumb p-relative">
        <a href="product-details.html" class="w-img">
            <img src="images/airpods-1.jpg" alt="product">
            <img class="second-img" src="images/airpods-1-2.jpg" alt="product">
        </a>
        <div class="product__action p-absolute">
            <ul>
                <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
    ...
    <div class="product__content text-center">
        <h6 class="product-name">
        <a class="product-item-link" href="product-details.php?val='.$item->id.'"> Airpods Pro pink</a>
        </h6>
        <div class="rating">
            <ul>
                <li><a href="#"><i class="far fa-star"></i></a></li>
...
<div class="product__item white-bg"><span class="cat-label green">new!</span>
    <div class="product__thumb p-relative">
        <a href="product-details.html" class="w-img">
            <img src="images/shirts2.jpg" alt="product">
            <img class="second-img" src="images/shirts-2-2.jpg" alt="product">
        </a>
        <div class="product__action p-absolute">
            <ul>
                <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
    ...
    <div class="product__content text-center">
        <h6 class="product-name">
        <a class="product-item-link" href="product-details.php?val='.$item->id.'"> Autumn Men Shirt</a>
                </h6>
        <div class="rating">
            <ul>
                <li><a href="#"><i class="far fa-star"></i></a></li>
...
<div class="product__item white-bg"><span class="cat-label green">new!</span>
    <div class="product__thumb p-relative">
        <a href="product-details.html" class="w-img">
            <img src="images/shirts-1.jpg" alt="product">
            <img class="second-img" src="images/shirts-1-2.jpg" alt="product">
        </a>
        <div class="product__action p-absolute">
            <ul>
                <li><a href="#" title="Add to Wishlist"><i class="fal fa-heart"></i></a></li>
    ...
    <div class="product__content text-center">
        <h6 class="product-name"> 
        <a class="product-item-link" href="product-details.php?val='.$item->id.'"> Dress Shirt For Men - Cotton</a>
        </h6>
        <div class="rating">
            <ul>
                <li><a href="#"><i class="far fa-star"></i></a></li>
...
<div class="product__item white-bg">
    ...
    <div class="product__content text-center">
        <h6 class="product-name">
            <a class="product-item-link" href="product-details.html" img="public/images/be> Blink Home Security Camera System 01   </a>
        </h6>
        <div class="rating">
            <ul>
                <li><a href="#"><i class="far fa-star"></i></a></li>
...
<div class="banner__item mb-30 w-img">
<a href="product-details.html"><img src="images/main-banner-1.jpg" alt=""></a>
</div>
</div>
<div class="col-xl-6 col-lg-6">
<div class="banner__item mb-30 w-img">
<a href="product-details.html"><img src="images/main-banner-2.jpg" alt=""></a>
</div>
</div>
</div>
</div>
...
<div class="col-xxl-2 col-xl-2 col-lg-3 col-md-6 col-sm-6">
    <div class="product__item-wrapper mb-20">
        <div class="product__item white-bg">
            <div class="product__thumb p-relative">
                <a href="product-details.html" class="w-img">
                    <img src="images/computer1.jpg" alt="product">
                    {{-- <img class="second-img" src="assets/img/shop/product/product-8.jpg" alt="product"> --}}
                </a>
                <div class="product__action p-absolute">
                    <ul>
            ...
            <div class="product__content text-center">
                <h6 class="product-name">
                    <a class="product-item-link" href="product-details.html"> Mini PC Thin Client HP T520 Dual Core AMD Computer   </a>
                </h6>
                <div class="rating">
                    <ul>
                        <li><a href="#"><i class="far fa-star"></i></a></li>
    ...
    <div class="product__item-wrapper mb-20">
        <div class="product__item white-bg">
            <div class="product__thumb p-relative">
                <a href="product-details.html" class="w-img">
                    <img src="images/computer2.jpg" alt="product">
                    {{-- <img class="second-img" src="assets/img/shop/product/product-4.jpg" alt="product"> --}}
                </a>
                <div class="product__action p-absolute">
                    <ul>
            ...
            <div class="product__content text-center">
                <h6 class="product-name">
                    <a class="product-item-link" href="product-details.html"> 3-in-1 Keyboard</a>
                </h6>
                <div class="rating">
                    <ul>
                        <li><a href="#"><i class="far fa-star"></i></a></li>
...
<div class="col-xxl-2 col-xl-2 col-lg-3 col-md-6 col-sm-6 ">
    <div class="product__item-wrapper mb-20">
        <div class="product__item white-bg">
            <div class="product__thumb p-relative">
                <a href="product-details.html" class="w-img">
                    <img src="images/computer3.jpg" alt="product">
            ...
            <div class="product__content text-center">
                <h6 class="product-name">
                    <a class="product-item-link" href="product-details.html">Core 2 Duo Mixed Case Without Hard and Ram    </a>
                </h6>
                <div class="rating">
                    <ul>
                        <li><a href="#"><i class="far fa-star"></i></a></li>
    ...
    <div class="product__item-wrapper mb-20">
        <div class="product__item white-bg">
            <div class="product__thumb p-relative">
                <a href="product-details.html" class="w-img">
                    <img src="images/computer4.jpg" alt="product">
            ...
            <div class="product__content text-center">
                <h6 class="product-name">
                    <a class="product-item-link" href="product-details.html">Dell Optiplex 7010 Core i5 4GB Ram, 1TB Hard Drive</a>
                </h6>
                <div class="rating">
                    <ul>
                        <li><a href="#"><i class="far fa-star"></i></a></li>
    ...
    <div class="product__item-wrapper mb-20">
        <div class="product__item white-bg">
            <div class="product__thumb product__thumb-big pb-15 p-relative">
                <a href="product-details.html" class="w-img">
                    <img src="images/computer9.jpg" alt="product">
            ...
            <div class="product__content text-center">
                <h6 class="product-name">
                    <a class="product-item-link" href="product-details.html"> High Optical Screen Protector Film for Apple MacBook New Pro 2021   </a>
                </h6>
                <div class="rating">
                    <ul>
                        <li><a href="#"><i class="far fa-star"></i></a></li>
...
<div class="col-xxl-2 col-xl-2 col-lg-6 col-md-6 col-sm-6">
    <div class="product__item-wrapper mb-20">
        <div class="product__item white-bg">
            <div class="product__thumb p-relative">
                <a href="product-details.html" class="w-img">
                    <img src="images/computer5.jpg" alt="product">
            ...
            <div class="product__content text-center">
                <h6 class="product-name">
                    <a class="product-item-link" href="product-details.html"> SRIWEN White Letters Arabic Keyboard</a>
                </h6>
                <div class="rating">
                    <ul>
                        <li><a href="#"><i class="far fa-star"></i></a></li>
    ...
    <div class="product__item-wrapper mb-20">
        <div class="product__item white-bg">
            <div class="product__thumb p-relative">
                <a href="product-details.html" class="w-img">
                    <img src="images/computer6.jpg" alt="product">
            ...
            <div class="product__content text-center">
                <h6 class="product-name">
                    <a class="product-item-link" href="product-details.html"> Colorful Silicone Anti Dust Plug for Laptop</a>
                </h6>
                <div class="rating">
                    <ul>
                        <li><a href="#"><i class="far fa-star"></i></a></li>
...
<div class="col-xxl-2 col-xl-2 col-lg-6 col-md-6 col-sm-6">
    <div class="product__item-wrapper mb-20">
        <div class="product__item white-bg">
            <div class="product__thumb p-relative">
                <a href="product-details.html" class="w-img">
                    <img src="images/computer7.jpg" alt="product">
            ...
            <div class="product__content text-center">
                <h6 class="product-name">
                    <a class="product-item-link" href="product-details.html"> Mini Vacuum USB Keyboard Brush Cleaning Tool</a>
                </h6>
                <div class="rating">
                    <ul>
                        <li><a href="#"><i class="far fa-star"></i></a></li>
    ...
    <div class="product__item-wrapper mb-20">
        <div class="product__item white-bg">
            <div class="product__thumb p-relative">
                <a href="product-details.html" class="w-img">
                    <img src="images/computer8.jpg" alt="product">
            ...
            <div class="product__content text-center">
                <h6 class="product-name">
                    <a class="product-item-link" href="product-details.html"> New Wood Portable Laptop Table Foldable Dormitory   </a>
                </h6>
                <div class="rating">
                    <ul>
                        <li><a href="#"><i class="far fa-star"></i></a></li>
